...
do
  ...
  mkdir -p ./pydracula/po/${line}/LC_MESSAGES/
  # create template POT
  ...
  sed -i 's/charset=CHARSET/charset=UTF-8/g' ./po/pydracula.pot
  # See if file already exists
  if [ -f ./po/${line}.po ] 
  then
    echo "Skipping ${line}"
    # update PO file
    msgmerge -o ./po/${line}.po ./po/${line}.po ./po/pydracula.pot
  else
  ...
  # create MO
  msgfmt ./po/${line}.po -o ./pydracula/po/${line}/LC_MESSAGES/pydracula.mo
